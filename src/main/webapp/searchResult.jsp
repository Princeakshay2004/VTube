...
<H5 class="fw-bold text-center"><%=msg1.getContent() %></h5>
  ...
  <!--Message end-->
	...
	<a href="/video/view/<%=video1.getVid()%>" style="text-decoration: none;color: white">
		<div class="card border-0">
		 <div class="card-body text-white black p-0">
		 <video controls="controls"  style="height: 12em; width: 22em; border-radius: 1%;margin: 0em">
  		<source src="https://res.cloudinary.com/dqg87xvqe/video/upload/v1723582392/<%=video1.getVideo()%>.mp4" type="video/mp4">
			...
			<div class="d-flex justify-content-end">
				<a href="#" onclick="watchCount()" class="nav-link me-3"><i class="fa fa-eye"></i> <span class="watch-counter">2.4K</span></a>
				<a href="#" onclick="doLike()" class="nav-link me-2"><i class="fa fa-thumbs-up"></i> <span class="like-counter">10.5K</span></a>
			</div>
		</div>
		</div>
		</a>
